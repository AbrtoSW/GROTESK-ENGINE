...
void Renderer::init_terrain_mesh_pipeline() {
	...
	heightMapPipeline.shaderType.vertexShader.file.path = "shaders/heightmap.vert";
	heightMapPipeline.shaderType.fragmentShader.file.path = "shaders/heightmap.frag";
...
void Renderer::init_terrain_compute_pipeline() {
	...
	terrainCompute.shaderType.computeShader.file.path =  "shaders/terrain_build_draws.comp" ;
...
void Renderer::init_terrain_brush_pipeline() {
	...
	terrainBrushCompute.shaderType.computeShader.file.path = "shaders/terrain_brush.comp" ;
...
void GLTFMetallic_Roughness::build_pipelines(VulkanEngine* engine, Renderer* renderer) {
	...
	newOpaquePipeline.shaderType.vertexShader.file.path = "shaders/mesh.vert";
	newOpaquePipeline.shaderType.fragmentShader.file.path = "shaders/mesh.frag";
